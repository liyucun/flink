...
public final class SchedulerUploadHeaders
        implements MessageHeaders<EmptyRequestBody, JarUploadResponseBody, EmptyMessageParameters> {

    public static final String URL = "/schedulers/upload";
    private static final SchedulerUploadHeaders INSTANCE = new SchedulerUploadHeaders();

    private SchedulerUploadHeaders() {}
    ...
    public static SchedulerUploadHeaders getInstance() {
        return INSTANCE;
    }

    @Override
    public String getDescription() {
        return "Uploads a scheduler script to the cluster. The jar must be sent as multi-part data. Make sure that the \"Content-Type\""
