...
public final class DependencyJarUploadHeaders
        implements MessageHeaders<EmptyRequestBody, JarUploadResponseBody, EmptyMessageParameters> {

    public static final String URL = "/dependency-jars/upload";
    private static final DependencyJarUploadHeaders INSTANCE = new DependencyJarUploadHeaders();

    private DependencyJarUploadHeaders() {}
    ...
    public static DependencyJarUploadHeaders getInstance() {
        return INSTANCE;
    }

    @Override
    public String getDescription() {
        return "Uploads a dependency jar to the cluster. The jar must be sent as multi-part data. Make sure that the \"Content-Type\""
